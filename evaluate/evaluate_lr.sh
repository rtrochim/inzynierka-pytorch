...
for dir in "${dirs[@]}"; do
  ...
  for file in "$dir"*.tar; do
    ...
    gnome-terminal --geometry 70x19+1920--90 --disable-factory -- python ./app/main.py evaluate \
      --episodes 100 --hidden_units0 40 --model0 "$file" vs_random &
    pid1=$!
    gnome-terminal --geometry 70x19+1920+-10 --disable-factory -- python ./app/main.py evaluate \
      --episodes 100 --hidden_units0 40 --model0 "$file" vs_gnubg --difficulty Beginner --host localhost --port 8001 &
    pid2=$!
    gnome-terminal --geometry 70x19--94--90 --disable-factory -- python ./app/main.py evaluate \
      --episodes 100 --hidden_units0 40 --model0 "$file" vs_gnubg --difficulty Intermediate --host localhost --port 8002 &
    pid3=$!
    gnome-terminal --geometry 70x19--94+-10 --disable-factory -- python ./app/main.py evaluate \
      --episodes 100 --hidden_units0 40 --model0 "$file" vs_gnubg --difficulty Expert --host localhost --port 8003 &
    pid4=$!
